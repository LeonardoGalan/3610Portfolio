...
class Grass {
  ...
  draw() {
    ...
    for (let i = 1; i < 6; i++) {
      ...
      c.lineTo(
        this.endX + Math.random() * 20 - 10,
        this.endY + Math.random() * 9
      );
      c.stroke();
    }
  }
...
//function for drawing the fence
...
//draws sky and ground with the colors created above
...
//filling the treeArray with several trees
